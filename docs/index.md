...
| [bus-namespaces.md](bus-namespaces.md) | `OVOSSkill` | Spec-only bus emission with transparent legacy bridging (ovos-spec-tools); PIPELINE-1/STOP-1 conformance |
...
See [settings.md](settings.md) for change callbacks and file watching.
