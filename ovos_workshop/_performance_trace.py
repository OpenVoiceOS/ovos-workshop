"""Opt-in request-correlated skill trace events.

Request identifiers are intentionally written only to structured trace logs;
they never become Prometheus labels or metric names.
"""
